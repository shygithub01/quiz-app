                ...
                {isEligible ? (
                  <>
                    ...
                    <div className="text-green-700 text-sm mt-1">
                      Henrico County students can register for the March 15th competition with $300 in prizes.
                    </div>
                  </>
                ) : (
                  <>
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="text-green-700">March 15, 2025 at 10:00 AM</div>
                  </div>
                  <div>
                    <div className="font-medium text-green-800">Duration:</div>
                    <div className="text-green-700">60 minutes (50 questions)</div>
                  </div>
                  <div>
                    <div className="font-medium text-green-800">Subjects:</div>
                    <div className="text-green-700">Math, Science, English, Social Studies</div>
                  </div>
                  <div>
                    <div className="font-medium text-green-800">Prize Pool:</div>
                    <div className="text-green-700">$300 ($150, $100, $50)</div>
                  </div>
                </div>
              </CardContent>
            </Card>
