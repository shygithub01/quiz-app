...
export const generateNewQuizFromDocument = async (
  ...
  try {
    ...
    console.error('❌ Error generating new quiz from document:', error);
    throw new Error(error instanceof Error ? error.message : 'Failed to generate new quiz from document');
  }
};
